...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const { name, mobNo, location, message } = formData;
          ...
          <div className="lg:w-[50%] sm:w-full flex flex-col gap-4 p-6">
            ...
            <div>
              <form
                ...
                className="flex w-full flex-col justify-center items-center bg-[#DA0000] rounded-sm p-6 gap-4"
              >
                <div className="flex lg:flex-row sm:flex-col w-full gap-4">
                  <span className="flex w-full flex-col gap-2">
                    ...
                    <input
                      ...
                      className="sm:p-3 md:p-2 h-[3.5rem] bg-white rounded-sm sm:text-lg md:text-xl"
                    />
                  </span>
                  <span className="flex w-full flex-col gap-2">
                    <span className="text-lg font-semibold text-white">
                ...
                <div className="flex lg:flex-row sm:flex-col w-full gap-4">
                  <span className="flex w-full flex-col gap-2">
                    ...
                    <input
                      ...
                      className="sm:w-full sm:p-3 h-[3.5rem] md:p-2 bg-white rounded-sm sm:text-lg md:text-xl"
                    />
                  </span>
                  <span className="flex w-full flex-col gap-2">
                    <span className="text-lg font-semibold text-white">
                ...
                <span className="flex w-full flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className="sm:w-full sm:p-3 max-h-[6rem] min-h-[6rem] md:p-2 bg-white rounded-sm sm:text-lg md:text-xl"
                  />
                </span>

                <button
                  type="submit"
                  className="h-[3rem] sm:w-[70%] md:w-[60%] lg:w-[50%] rounded-sm bg-white border-2 border-[#462A7A] hover:bg-[#DA0000] hover:text-white flex justify-center items-center text-[#DA0000] sm:text-xl lg:text-2xl font-semibold"
                >
                  Send Message
                </button>
              </form>
