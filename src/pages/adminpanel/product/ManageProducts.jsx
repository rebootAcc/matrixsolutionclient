...
const ManageProducts = () => {
  ...
  const initialPage = parseInt(queryParams.get("page"), 10) || 1; // Get the current page from query params or default to 1
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="w-[97%] bg-[#191C20]">
          <div className="flex flex-col gap-2">
            <div className="grid grid-cols-7 p-4 border-b-2 border-[#2E2F32]  text-white text-lg font-semibold">
            ...
            <div className="flex flex-col h-screen no-scrollbar overflow-auto">
              {currentItems.length > 0 ? (
                currentItems.map((product, index) => (
                  <div
                    className="grid grid-cols-7 h-fit items-center border-b border-[#2E2F32] p-4 text-[#CCCCCC] text-base font-semibold"
                    key={index}
                  >
                    ...
                    <div className="flex flex-row items-center font-semibold gap-3">
                      ...
                      >
                        {loading[product.productId] ? "Deleting..." : "Delete"}
                      </button>
                    </div>
                  </div>
                ))
